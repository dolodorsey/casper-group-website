...
const BRANDS = [
  ...
  { name: "Tha Morning After", type: "Breakfast", logo: "/images/logo-morning-after.png", portal: "/images/portal-morning-after.jpeg", food: ["/images/morning-french-toast.jpg", "/images/morning-sandwiches.jpg"], accent: "#D89A2B", bg: "#1a1608", tagline: "Wake up legendary.", desc: "Creative breakfast culture engineered for craveability and all-day repeat traffic. French toast that makes you forget last night." },
  ...
  { name: "Espresso Co.", type: "Coffee Lab", logo: "/images/logo-espresso-co.png", portal: "/images/portal-espresso.jpeg", food: ["/images/espresso-lab.png", "/images/espresso-latte.png"], accent: "#8A6A3A", bg: "#15120a", tagline: "Science of the perfect cup.", desc: "Modern coffee culture meets lab precision. Every pour is an experiment. Every sip is the result." },
  { name: "Mojo Juice", type: "Juice & Smoothies", logo: "/images/logo-mojo-juice.png", portal: "/images/portal-mojo.jpeg", food: ["/images/mojo-smoothie.png"], accent: "#4A8A3A", bg: "#0e1608", tagline: "Fuel the ritual.", desc: "Fresh-pressed ritual with bright wellness positioning and lifestyle brand appeal." },
  { name: "Mr. Oyster", type: "Seafood Bar", logo: "/images/logo-mr-oyster.png", portal: "/images/portal-mr-oyster.jpeg", food: ["/images/oyster-scallops.jpg"], accent: "#3A6A8A", bg: "#0a1018", tagline: "The deep end of flavor.", desc: "Elevated seafood with visual authority. Squid ink pasta, seared scallops, calamari towers." },
  { name: "Sweet Tooth", type: "Desserts", logo: "/images/logo-sweet-tooth.png", portal: "/images/portal-sweet-tooth.jpeg", food: [], accent: "#C83A8A", bg: "#180a18", tagline: "Indulgence engineered.", desc: "Dessert indulgence engineered for impulse, social virality, and high-margin volume." },
  { name: "Taco Yaki", type: "Fusion", logo: "/images/logo-taco-yaki.png", portal: "/images/portal-taco-yaki.png", food: ["/images/taco-platter.jpg", "/images/taco-hibachi.jpg"], accent: "#C85A1A", bg: "#1a1008", tagline: "East meets west. Fire meets grill.", desc: "Fusion tacos meet hibachi heat. Wood-fired tortillas loaded with global flavors." },
  { name: "Toss'd", type: "Healthy Bowls", logo: "/images/logo-tossd.png", portal: "/images/portal-tossd.jpeg", food: [], accent: "#4A8A3A", bg: "#0e1608", tagline: "Fresh. Fast. No excuses.", desc: "Fresh bowls and salads with speed, simplicity, and wellness-forward brand identity." },
  { name: "Pasta Bish", type: "Pasta", logo: "/images/logo-pasta-bish.png", portal: "/images/portal-pasta-bish.jpeg", food: ["/images/pasta-fettuccine.jpg", "/images/pasta-marinara.jpg"], accent: "#C83A3A", bg: "#180808", tagline: "Comfort with attitude.", desc: "Comfort-food pasta with personality. Creamy fettuccine, proper marinara, fresh herbs." },
];
...
function Hero() {
  ...
  return (
    <section style={{ position: "relative", width: "100%", height: "100vh", overflow: "hidden", background: C.bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, bottom: 0, width: "28%", zIndex: 2, pointerEvents: "none", background: `linear-gradient(to right, ${C.bg} 0%, ${C.bg}dd 20%, ${C.bg}66 50%, transparent 100%)` }} />
      <div style={{ position: "absolute", top: 0, right: 0, bottom: 0, width: "28%", zIndex: 2, pointerEvents: "none", background: `linear-gradient(to left, ${C.bg} 0%, ${C.bg}dd 20%, ${C.bg}66 50%, transparent 100%)` }} />
...
function Thesis() {
  return (
    <section style={{ background: C.bg, padding: "clamp(80px,10vh,140px) clamp(32px,5vw,80px)", position: "relative" }}>
      <Grain opacity={0.02} />
  ...
  return (
    <section id="brands" style={{ background: C.bg, paddingBottom: 0 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "2px", background: C.border }}>
        {BRANDS.map((b, i) => (
          <div key={b.name} onMouseEnter={() => setHovered(i)} onMouseLeave={() => setHovered(null)} onClick={() => setExpanded(expanded === i ? null : i)}
...
function FoodGallery() {
  const foods = [
    { src: "/images/angel-wings-plate.jpg", brand: "Angel Wings", w: "2" },
    { src: "/images/patty-smashburger.jpg", brand: "Patty Daddy", w: "1" },
    { src: "/images/oyster-scallops.jpg", brand: "Mr. Oyster", w: "1" },
    { src: "/images/pasta-marinara.jpg", brand: "Pasta Bish", w: "1" },
    { src: "/images/taco-platter.jpg", brand: "Taco Yaki", w: "1" },
    { src: "/images/morning-french-toast.jpg", brand: "Morning After", w: "1" },
    { src: "/images/espresso-latte.png", brand: "Espresso Co.", w: "1" },
    { src: "/images/taco-hibachi.jpg", brand: "Taco Yaki", w: "2" },
    { src: "/images/pasta-fettuccine.jpg", brand: "Pasta Bish", w: "1" },
    { src: "/images/morning-sandwiches.jpg", brand: "Morning After", w: "1" },
  ];
  return (
    <section style={{ background: C.bg, padding: "clamp(80px,10vh,120px) 0", position: "relative" }}>
      <Grain opacity={0.02} />
      <div style={{ padding: "0 clamp(32px,5vw,80px) clamp(40px,5vh,56px)", maxWidth: "1400px", margin: "0 auto" }}>
        <Reveal>
          <div style={{ fontFamily: F.mono, fontSize: "9px", letterSpacing: "0.5em", textTransform: "uppercase", color: C.gold, marginBottom: "16px", display: "flex", alignItems: "center", gap: "12px" }}>
            <span style={{ width: "32px", height: "1px", background: C.gold, display: "inline-block" }} />
            From Our Kitchens
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "3px", padding: "0 3px" }}>
        {foods.map((f, i) => (
          <Reveal key={i} delay={0.05 * i} y={30}>
            <div style={{ position: "relative", overflow: "hidden", gridColumn: f.w === "2" ? "span 2" : "span 1", aspectRatio: f.w === "2" ? "2/1" : "4/3", background: "#0a0a0a" }}>
...
function Operation() {
  return (
    <section id="story" style={{ background: C.bg, padding: "clamp(80px,10vh,140px) clamp(32px,5vw,80px)", position: "relative" }}>
      <Grain opacity={0.02} />
...
function WhyCasper() {
  return (
    <section style={{ background: C.bg, padding: "clamp(80px,10vh,120px) clamp(32px,5vw,80px)", position: "relative" }}>
      <Grain opacity={0.02} />
