...
const MENU_ENDPOINT = 'https://qhgmukwoennurwuvmbhy.supabase.co/functions/v1/pasta-bish-intake?resource=menu';
...
export async function GET() {
  ...
  try {
    const response = await fetch(MENU_ENDPOINT, {
      ...
      headers: { 'User-Agent': 'pasta-bish-health-check/1.0' },
    });
