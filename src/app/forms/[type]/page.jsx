...
const BRAND = { name: 'Casper Group', bg: '#0D0D0D', accent: '#C9A961', text: '#F0EDE5', font: "'DM Sans', serif" };
    ...
    <div style={{minHeight:'100vh',background:BRAND.bg,color:BRAND.text,fontFamily:BRAND.font}}>
      ...
      <div style={{position:'relative',zIndex:1,padding:'60px 20px 80px'}}>
        <div style={{maxWidth:560,margin:'0 auto'}}>
          ...
          <p style={{textAlign:'center',marginTop:40,fontSize:11,opacity:0.25,fontFamily:"'DM Sans',sans-serif",letterSpacing:1}}>© {new Date().getFullYear()} Casper Group — Powered by The Kollective</p>
        </div>
      </div>
    </div>
  );
